...
@section('content')
     ...
     <div class="index-pro1-list">
          <dl>
               ...
               <dd class="ip-text"><a href="{{url('index/proinfo/'.$v->goods_id)}}">{{$v->goods_name}}</a><span>库存:{{$v->goods_num}}</span></dd>
     ...
     <div class="prolist">
      <dl>
       <dt><a href="proinfo.html"><img src="/static/index/images/prolist1.jpg"/></a></dt>
       <dd>
