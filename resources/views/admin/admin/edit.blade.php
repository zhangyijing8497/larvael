...
<body>
    <center><h3><b>管理员修改</b></h3></center>
    <form class="form-horizontal" role="form" action="{{url('admin/update/'.$data->admin_id)}}" method="post">
        @csrf
        <div class="form-group">
            <label for="firstname" class="col-sm-2 control-label">用户名</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" value="{{$data->admin_name}}" name="admin_name" id="firstname" placeholder="请输入用户名">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="password" class="form-control" value="{{$data->admin_pwd}}" name="admin_pwd" id="admin_pwd" placeholder="请输入密码">
